...
import type { StorefrontProduct } from '@moonbase.sh/vue'
...
<template>
  <div class="rounded-lg shadow-lg hover:shadow-xl max-w-prose overflow-hidden transition-shadow duration-500">
    <div class="aspect-square bg-blue-800">
      <img v-if="product.iconUrl" class="h-full w-auto mx-auto" :src="product.iconUrl" alt="">
    </div>
    <div class="flex p-4 items-center">
      ...
      <div class="flex flex-col items-center justify-around">
        <div class="pb-2 text-lg whitespace-nowrap">
          {{ product.defaultVariation ? formatCurrency(product.defaultVariation.price[cart.currency.value], cart.currency.value) : null }}
        </div>
        <button
